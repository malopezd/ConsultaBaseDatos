...
--CASO 3
SELECT
    TO_CHAR(TTC.FECHA_TRANSACCION, 'MM"/"YYYY') AS "MES TRANSACCIÓN",
...
GROUP BY TO_CHAR(TTC.FECHA_TRANSACCION, 'MM"/"YYYY'), ttt.NOMBRE_TPTRAN_TARJETA,aps.PORC_APORTE_SBIF
...
SELECT 
    ...
    cli.APMATERNO AS "NOMBRE CLIENTE",
    TO_CHAR(SUM(ttc.MONTO_TOTAL_TRANSACCION), '$999G999G999') AS "MONTO AVANCES/SUPER AVANCES",
    (CASE WHEN SUM(ttc.MONTO_TOTAL_TRANSACCION) BETWEEN 0 and  999999 THEN 'SIN CATEGORIZAR'
